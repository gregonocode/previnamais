...
const GONORRHEA_QUESTIONS = [
  ...
  {
    id: "q2",
    text: "Você notou corrimento anormal (amarelado, esverdeado ou com mau cheiro) na região genital?",
    answers: [
  ...
  {
    id: "q4",
    text: "Você teve contato sexual com alguém que foi diagnosticado com gonorreia?",
    answers: [
      { id: "a1", label: "Sim", score: 3 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q6",
    text: "Você notou dor ou desconforto na região pélvica ou abdominal (especialmente em mulheres)?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q7",
    text: "Você sentiu dor ou inchaço nos testículos (para homens)?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q9",
    text: "Você teve dor de garganta persistente ou dificuldade para engolir após sexo oral?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
...
export default function GonorrheaQuizPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-center mb-6">Quiz de Avaliação de Risco para Gonorreia</h1>
          <MultiStepQuiz
            questions={GONORRHEA_QUESTIONS}
