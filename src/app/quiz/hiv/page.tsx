...
const HIV_QUESTIONS = [
  ...
  {
    id: "q2",
    text: "Você teve contato sexual com alguém que foi diagnosticado com HIV/AIDS?",
    answers: [
  ...
  {
    id: "q3",
    text: "Você compartilhou agulhas ou seringas com outra pessoa (por exemplo, para uso de drogas injetáveis)?",
    answers: [
      { id: "a1", label: "Sim", score: 3 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q4",
    text: "Você teve febre persistente, fadiga extrema ou perda de peso sem motivo aparente?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q6",
    text: "Você teve infecções frequentes, como candidíase oral ou pneumonia, recentemente?",
    answers: [
      { id: "a1", label: "Sim", score: 3 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q10",
    text: "Você sentiu suor noturno intenso ou calafrios sem motivo aparente?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
...
export default function HIVQuizPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-center mb-6">Quiz de Avaliação de Risco para HIV/AIDS</h1>
          <MultiStepQuiz
            questions={HIV_QUESTIONS}
