...
const TRICHOMONIASIS_QUESTIONS = [
  ...
  {
    id: "q2",
    text: "Você notou corrimento vaginal ou uretral com odor forte, espumoso ou de cor amarelada/esverdeada?",
    answers: [
  ...
  {
    id: "q3",
    text: "Você sentiu coceira, ardor ou irritação na região genital?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q4",
    text: "Você teve contato sexual com alguém que foi diagnosticado com tricomoniase?",
    answers: [
      { id: "a1", label: "Sim", score: 3 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q6",
    text: "Você sentiu dor ou desconforto ao urinar ou durante relações sexuais?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q7",
    text: "Você notou vermelhidão ou inchaço na região genital?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q9",
    text: "Você notou sangramento vaginal após relações sexuais ou entre períodos menstruais (para mulheres)?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q10",
    text: "Você sentiu dor abdominal baixa ou desconforto na região pélvica (especialmente em mulheres)?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
...
export default function TrichomoniasisQuizPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-center mb-6">Quiz de Avaliação de Risco para Tricomoniase</h1>
          <MultiStepQuiz
            questions={TRICHOMONIASIS_QUESTIONS}
