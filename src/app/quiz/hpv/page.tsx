...
const HPV_QUESTIONS = [
  ...
  {
    id: "q2",
    text: "Você notou verrugas ou lesões na região genital, anal ou oral?",
    answers: [
  ...
  {
    id: "q3",
    text: "Você teve coceira, ardor ou desconforto na região genital ou anal?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q4",
    text: "Você teve contato sexual com alguém que foi diagnosticado com HPV?",
    answers: [
      { id: "a1", label: "Sim", score: 3 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q5",
    text: "Você tem histórico de infecções sexualmente transmissíveis (ISTs)?",
    answers: [
      { id: "a1", label: "Sim", score: 2 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q6",
    text: "Você notou alterações no colo do útero ou resultados anormais em exames de Papanicolau (para mulheres)?",
    answers: [
      { id: "a1", label: "Sim", score: 3 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q9",
    text: "Você notou sangramento vaginal anormal (para mulheres) ou sangramento na região genital (para homens)?",
    answers: [
      { id: "a1", label: "Sim", score: 3 },
      { id: "a2", label: "Não", score: 0 },
      { id: "a3", label: "Não sei responder", score: 1 },
  ...
  {
    id: "q10",
    text: "Você já foi vacinado contra o HPV?",
    answers: [
...
export default function HPVQuizPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-center mb-6">Quiz de Avaliação de Risco para HPV</h1>
          <MultiStepQuiz
            questions={HPV_QUESTIONS}
